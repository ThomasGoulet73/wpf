...
namespace MS.Internal.Text.TextInterface
{
    ...
    internal unsafe interface IDWriteFontFileStreamMirror
    {
        /// <summary>
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal unsafe interface IDWriteFontFileEnumeratorMirror
    {
        /// <summary>
        ...
        [PreserveSig]
        int MoveNext(
            [Out, MarshalAs(UnmanagedType.Bool)] int* hasCurrentFile
            );
